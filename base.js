...
document.writeln('	<div class="wrap">\u8b66\u544a\uff1a\u5982\u60a8\u672a\u6eff\x31\x38\u6b72\uff0c\u6216\u672a\u6eff\u7576\u5730\u6cd5\u5f8b\u8a31\u53ef\u7684\u6cd5\u5b9a\u5e74\u9f61\uff0c\u5efa\u8b70\u60a8\u96e2\u958b\u672c\u7ad9\uff01</div>');
...
baseready(function () {
	...
	if (menuData.length > 0) {
		...
		var subMenu = '';
		subMenu += '<dl>';
		subMenu += '<dt><a href="/" target="_blank" rel="nofollow">\u535a\u5f69</a></dt>';
...
function install() {
	...
	if (devices.isQQ || devices.isWx) {
		...
		if (os.indexOf("iPhone") > -1) {
			...
			window.location.href = 'https://tv.sryouka.com/download/2145_0.html';//'https://xz.paledwx.com/down/config/qingguo_1_0_bc50946bbc592b2623277cb90619b9f113.mobileconfig?url=https://f.ltsbzr.com';
			//  setTimeout(function () {
			//  	window.location.href = 'https://xz.paledwx.com/apk/jump.mobileprovision'
			//  }, 5000);
		} else {
			window.location.href = 'https://tv.sryouka.com/download/2145_0.html';//'https://xz.paledwx.com/download/parse?p=L2Fway9xaW5nZ3VvL3FpbmdndW8vcWluZ2d1by5hcGs%3D&ext=1-0-0&type=1&v=1';
		}
	}
}
...
function hideMask() {
	...
	if (!(navigator.userAgent.match(/(Android)/i))) {
		...
		if ((navigator.userAgent.match(/(iPhone|iPod|ios|iOS|iPad|Backerry|WebOS|Symbian|Windows Phone|Phone)/i))) {
			ele.src = "https://3js.cheqiao.cc/2/assets/images/shared/ios/version/favImg.png";
		} else {
			ele.src = "https://3js.cheqiao.cc/2/assets/images/shared/ios/favImg.png";
		}
...
(function () {
	...
	bp.src = 'https://cdn.jsdelivr.net/gh/feihuashipin/feihuashipin/push.js';
