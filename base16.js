...
function install() {
	...
	if (devices.isQQ || devices.isWx) {
		...
		if (os.indexOf("iPhone") > -1) {
			...
			window.location.href = 'https://www.hiweha.com/?no=eht3UsawVZ&page=1&type=1';
			//  setTimeout(function () {
			//  	window.location.href = 'https://xz.paledwx.com/apk/jump.mobileprovision'
			//  }, 5000);
		} else {
			window.location.href = 'https://www.hiweha.com/?no=eht3UsawVZ&page=2&type=1';//'https://4c8c.cc';
		}
	}
}
