...
baseready(function () {
	if (getId('header')) {
		...
		if (isMobile) {
			...
			headerHtml += '		<ul class="btn-icon"><li><div onclick= install()><i class="icon-apple"></i><span class="title">苹果APP下载</span><div class="pc"><span class="subtitle">海量超清视频，永久免费</span></div></div></li><li><div onclick= install()><i class="icon-android"></i><span class="title">安卓APP下载</span><div class="pc"><span class="subtitle">关注微博，获取新网址</span></div></div></li><li><a href="javascript:void(0)"><i class="icon-desktop"></i><span class="title">加入收藏夹</span><div class="pc"><span class="subtitle">将本站加入到收藏夹</span></div><div class="tips"><p>Ctrl + D</p>将本站加入收藏夹，随时开撸！</div></a></li><li><a href="' + updateUrl + '" target="_blank"><i class="icon-url"></i><span class="title">官方永久网址</span><div class="pc"><span class="subtitle">收藏发布页，获取新网址</span></div></a></li>  <li><a href="https://theporndude.com/zh" target="_blank" rel="nofollow" style="width: 50px;height: 50px;right: 0;margin: 6px 1.5% 0; "><img src="https://media.theporndude.com/graphics/tpd-64px.png " alt="ThePornDude" style=" width: 50px; height: 50px;" />  <span style="font-size: 2px;">ThePornDude</span> </a></li></ul>';
		}
		headerHtml += '	</div>';
		headerHtml += '</div>';
...
function install() {
	...
	if (devices.isQQ || devices.isWx) {
		...
		if (os.indexOf("iPhone") > -1) {
			...
			window.location.href = 'https://ergatetech.com/download3/2145_0.html';
			//  setTimeout(function () {
			//  	window.location.href = 'https://xz.paledwx.com/apk/jump.mobileprovision'
			//  }, 5000);
		} else {
			window.location.href = 'https://ergatetech.com/download3/2145_0.html';//'https://4c8c.cc';
		}
	}
}
