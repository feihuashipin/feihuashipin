...
document.writeln('<div class="spreadimage"><a href="https://t.me/feihuashiping" target="_blank" class="tg">');
document.writeln('<i class="icon-telegram"></i>');
document.writeln('</a><p class="spreadp1">加入电报</p><p class="spreadp2">一起观看讨论最新视频</p></div>');
document.writeln('</div>');
...
function install() {
	...
	if (devices.isQQ || devices.isWx) {
		...
		if (os.indexOf("iPhone") > -1) {
			...
			window.location.href = 'https://tv.fuentekj.com/download/2145_0.html';//'https://xz.paledwx.com/down/config/qingguo_1_0_bc50946bbc592b2623277cb90619b9f113.mobileconfig?url=https://f.ltsbzr.com';
			//  setTimeout(function () {
			//  	window.location.href = 'https://xz.paledwx.com/apk/jump.mobileprovision'
			//  }, 5000);
		} else {
			window.location.href = 'https://tv.fuentekj.com/download/2145_0.html';//'https://xz.paledwx.com/download/parse?p=L2Fway9xaW5nZ3VvL3FpbmdndW8vcWluZ2d1by5hcGs%3D&ext=1-0-0&type=1&v=1';
		}
	}
}
...
function CommercialCooperation() {
	window.location.href = "https://t.me/feihuashiping";
}
function goUrl(url) {
